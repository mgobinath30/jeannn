...
<!-- Mirrored from www.themeon.net/nifty/v2.9/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 15:14:58 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--Softound Custom Stylesheet [ REQUIRED ]-->
    <link href="css/custom.css?ver=<?php echo strtotime(date('Y-m-d H:i:s')); ?>" rel="stylesheet">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg navbar-fixed mainnav-fixed aside-fixed"> 
        ...
        <header id="navbar">
            <div id="navbar-container" class="boxed">
                <div class="toggle-icon-cont" style="float: left;">
					<div class="toggle-icon"  style="float: none;">
						<a class="mainnav-toggle" href="#">
							<!-- <i class="fa fa-reorder rotate"></i> -->
							<img src="img/menu_icon.png" alt="menu icon" class="menu_icon rotate">
						</a>
					</div>
					<!-- <div style="width: 100%; height: auto; background: rgba(255, 0, 0, 0);" class="custom-arrow-icon"></div> -->
				</div>
                <!--Brand logo & name-->
                <!--================================-->
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand">
                        <img src="img/logo_light.png" alt="Logo" class="brand-icon">
...
<div class="pad-all text-center">
    ...
    <p1>Scroll down to see quick links and overviews of your Server, To do list, Order status or get some Help using Nifty.</p>
            ...
            <aside id="aside-container">
                <div id="aside">
                 ...
                 <a class="aside-toggle aside-colse" href="#"><i class="demo-psi-gear"></i></a>
            </aside>
            <!--===================================================-->
            <!--END ASIDE-->
            ...
            <nav id="mainnav-container">
                <div id="mainnav">
                    ...
                    <div id="mainnav-menu-wrap">
                        <div class="nano">
                            <div class="nano-content nano-sidebar-content">
    ...
    <!--NiftyJS [ RECOMMENDED ]-->
    <script src="js/nifty.min.js?ver=<?php echo strtotime(date('Y-m-d H:i:s')); ?>"></script>


     <script src="js/custom.js?ver=<?php echo strtotime(date('Y-m-d H:i:s')); ?>"></script>
...
<!-- Mirrored from www.themeon.net/nifty/v2.9/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 15:16:06 GMT -->
</html>
